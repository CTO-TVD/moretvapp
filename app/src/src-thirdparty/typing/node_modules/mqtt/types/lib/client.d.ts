...
export declare class MqttClient {
  ...
  public addListener (event: 'message', cb: OnMessageCallback): this
  public addListener (event: 'packetsend' | 'packetreceive', cb: OnPacketCallback): this
  public addListener (event: 'error', cb: OnErrorCallback): this
