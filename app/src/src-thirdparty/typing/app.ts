...
for (const mod of modules) {
    ...
    const fileJson = JSON.parse(fileContent) as IPackage;

    const license: ILicense = { name: fileJson.name, license: fileJson.license, version: fileJson.version, modified: "no", content: [] };
