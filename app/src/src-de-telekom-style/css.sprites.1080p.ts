...
export class CssSprites1080p implements ICssSprites {

    private readonly back = `url(${fileblob.spritemap || "src/src-de-telekom-style/1080p/sprite.png"})`;
