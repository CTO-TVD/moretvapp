...
define(["require", "exports", "react", "src/src-de-telekom-react/public", "src/src-de-telekom-style/public", "../../translation/public", "../../component/purchase/public"], function (require, exports, React, public_1, public_2, public_3, public_4) {
    ...
    exports.MtvDtPurchaseStep1Component = void 0;
    var MtvDtPurchaseStep1Component = (function (_super) {
        __extends(MtvDtPurchaseStep1Component, _super);
        function MtvDtPurchaseStep1Component(props, context) {
            var _this = _super.call(this, props, context) || this;
            _this.state = { opt1Focused: false, opt2Focused: false };
            return _this;
        }
        MtvDtPurchaseStep1Component.prototype.handleInfoKey = function () {
        ...
        MtvDtPurchaseStep1Component.prototype.changeOptionAccepted = function (option, isChecked, context) {
            if (this.props.changeOptionAccepted) {
                this.props.changeOptionAccepted({ option: option, isChecked: !isChecked, context: context });
            }
        };
        MtvDtPurchaseStep1Component.prototype.render = function () {
            var _this = this;
            var _a, _b, _c;
            return React.createElement(React.Fragment, null,
                React.createElement(public_1.NavigationContainer, { id: "mtvPurchase#DT#Step1", strictHorizontal: true, autofocus: true, className: this.ID },
                    ...
                    React.createElement(public_1.NavigationContainer, { id: "mtvPurchase#DT#Step1_Data", strictHorizontal: true, autofocus: true, className: "Content_Container" },
                        ...
                        ((_a = this.props.package.CustomValues) === null || _a === void 0 ? void 0 : _a.TermsOfUse) && React.createElement("div", { className: "BookingStep_TextBody" },
                            this.props.package.CustomValues.TermsOfUse.Title &&
                                React.createElement("div", { id: "Title", className: public_2.Css.fonts2.a_fo_h2_3 }, this.props.package.CustomValues.TermsOfUse.Title),
                            this.props.package.CustomValues.TermsOfUse.Text &&
                                React.createElement("div", { id: "Text", style: { color: public_2.Css.colors.A_CO_6 }, className: public_2.Css.fonts2.a_fo_b2__, dangerouslySetInnerHTML: { __html: this.props.package.CustomValues.TermsOfUse.Text } }),
                            (((_b = this.props.package.CustomValues.TermsOfUse.Opt1) === null || _b === void 0 ? void 0 : _b.Title) && this.props.package.CustomValues.TermsOfUse.Opt1.Text) &&
                                React.createElement(public_1.Button.CheckboxV20Option, { id: "opt1", text: this.props.package.CustomValues.TermsOfUse.Opt1.Title, type: this.state.opt1Focused ? "standard" : "small", subText: this.state.opt1Focused ? this.props.package.CustomValues.TermsOfUse.Opt1.Text : undefined, autofocus: true, className: "dttv-m-in51", isChecked: this.props.context.optionsAccepted[0], onFocusIn: function () {
                                    ...
                                    }, onClick: function () { _this.changeOptionAccepted(0, _this.props.context.optionsAccepted[0], 2); } }),
                            (((_c = this.props.package.CustomValues.TermsOfUse.Opt2) === null || _c === void 0 ? void 0 : _c.Title) && this.props.package.CustomValues.TermsOfUse.Opt2.Text) &&
                                React.createElement(public_1.Button.CheckboxV20Option, { id: "opt2", text: this.props.package.CustomValues.TermsOfUse.Opt2.Title, type: this.state.opt2Focused ? "standard" : "small", className: "dttv-m-in51 lastCheckbox", isChecked: this.props.context.optionsAccepted[1], subText: this.state.opt2Focused ? this.props.package.CustomValues.TermsOfUse.Opt2.Text : undefined, onFocusIn: function () {
                                    ...
                                    }, onClick: function () { _this.changeOptionAccepted(1, _this.props.context.optionsAccepted[1], 2); } })),
                        React.createElement("hr", null),
                        React.createElement(public_4.MtvPurchaseComponent.PurchaseButtonNavbar, { context: this.props.context }))));
        };
        MtvDtPurchaseStep1Component = __decorate([
            public_1.reactComponent({
                ID: "purchase-step1-component",
                styles: [
                    public_2.selector("&")
                        .props({
                        overflow: "hidden",
        ...
        ], MtvDtPurchaseStep1Component);
        return MtvDtPurchaseStep1Component;
    }(public_1.ReactBaseComponent));
    exports.MtvDtPurchaseStep1Component = MtvDtPurchaseStep1Component;
});
//# sourceMappingURL=dt_purchasestep1.js.map